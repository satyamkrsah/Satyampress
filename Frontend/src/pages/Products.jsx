    ...
    <div className="bg-white dark:bg-background-dark transition-colors duration-300 min-h-screen py-10 md:py-14">
      <div className="w-full px-4 sm:px-8 lg:px-12">
        <div className="mb-10 text-center">
          <p className="section-subheading mb-2">Catalogue</p>
          ...
          <button
            ...
            className={`px-4 py-2 text-xs uppercase tracking-wider border transition-all ${
              !priceRange
                ...
                : 'border-black dark:border-white dark:border-black dark:border-white transition-colors duration-300 bg-white dark:bg-background-dark transition-colors duration-300 text-black dark:text-cream-dark hover:border-gold hover:text-gold'
            }`}
          >
            All Prices
          </button>
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          <div className="w-full lg:w-56 shrink-0">
            <div className="bg-white dark:bg-background-dark transition-colors duration-300 p-5 border border-black dark:border-white dark:border-black dark:border-white transition-colors duration-300 sticky top-36">
              ...
              <div className="mb-6">
                <div className="relative">
                  <input
                    type="text"
                    placeholder="Search..."
                    className="w-full pl-9 pr-4 py-2 bg-white dark:bg-background-dark transition-colors duration-300 border border-black dark:border-white dark:border-black dark:border-white transition-colors duration-300 text-sm focus:outline-none focus:ring-1 focus:ring-gold text-black dark:text-cream-dark"
                    value={searchQuery}
              ...
              {(searchQuery || priceRange || selectedCategory !== 'All') && (
                <button
                  ...
                  className="mt-6 w-full flex items-center justify-center gap-2 text-xs uppercase tracking-wider text-black dark:text-cream-dark hover:text-gold py-2 border border-black dark:border-white dark:border-black dark:border-white transition-colors duration-300 hover:border-gold transition-colors"
                >
