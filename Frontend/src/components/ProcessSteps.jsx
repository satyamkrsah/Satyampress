    ...
    <section className="py-12 md:py-16 bg-[#fffdfa] dark:bg-background-dark transition-colors duration-300">
      <div className="w-full px-4 sm:px-8 lg:px-12">
        <div className="text-center mb-12">
          <p className="text-[#822f32] tracking-[0.3em] text-xs sm:text-sm uppercase mb-4 font-medium">
            How It Works
          </p>
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-serif text-black dark:text-white mb-6">
            Your Order In Just Five Steps
          </h2>
          ...
          <p className="text-black/70 dark:text-white/70 max-w-2xl mx-auto text-sm md:text-base leading-relaxed">
            From consultation to delivery, we craft your perfect prints with
            care and precision.
          </p>
        </div>
            ...
            return (
              ...
              >
                ...
                <div className="relative mb-4">
                  {/* Step Circle */}
                  <div
                    className={`w-28 h-28 md:w-32 md:h-32 rounded-full flex items-center justify-center transition-all duration-300 bg-white dark:bg-[#1a1a1a] ${
                      isActive
                        ? "border-[1.5px] border-[#822f32] shadow-sm"
                        : "border border-[#822f32]/40 hover:border-[#822f32]/80"
                    }`}
                  >
                    <Icon
                      className={`w-10 h-10 md:w-12 md:h-12 transition-colors duration-300 ${
                        isActive
                          ? "text-[#822f32]"
                          : "text-[#822f32]/70 group-hover:text-[#822f32]"
                      }`}
                      strokeWidth={1}
                    />
                  </div>
                ...
                <h3
                  className={`text-sm md:text-base font-medium tracking-wide transition-colors duration-300 ${
                    isActive
                      ...
                      : "text-black/80 dark:text-white/80 group-hover:text-black"
                  }`}
                >
                  {step.title}
                </h3>
