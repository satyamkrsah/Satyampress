      ...
      <aside className="w-64 bg-white border-r border-gray-200 flex flex-col hidden md:flex">
        ...
        <div className="p-4 border-t border-gray-200">
          <button 
            ...
            className="flex items-center gap-3 px-3 py-2.5 w-full text-left rounded-lg text-red-600 hover:bg-red-50 transition-colors font-medium"
          >
            <LogOut size={20} />
            Logout
          </button>
      ...
      <main className="flex-1 flex flex-col overflow-hidden">
        ...
        <header className="h-16 bg-white border-b border-gray-200 flex items-center justify-between px-6 shrink-0">
          <div className="flex items-center gap-4">
            ...
            <h2 className="text-lg font-semibold text-gray-800 hidden sm:block">Admin Panel</h2>
          </div>
